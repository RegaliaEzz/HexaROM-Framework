...
.method static synthetic access$1700(Lcom/samsung/cpp/CPPProvider;)I
    .locals 1
    .param p0, "x0"    # Lcom/samsung/cpp/CPPProvider;
...
.method static synthetic access$1800(Lcom/samsung/cpp/CPPProvider;)V
    .locals 0
    .param p0, "x0"    # Lcom/samsung/cpp/CPPProvider;

    .prologue
    .line 53
    invoke-direct {p0}, Lcom/samsung/cpp/CPPProvider;->startWifiScan()V

    return-void
.end method

.method static synthetic access$1900(Lcom/samsung/cpp/CPPProvider;BBBB)Z
    .locals 1
    .param p0, "x0"    # Lcom/samsung/cpp/CPPProvider;
    .param p1, "x1"    # B
    .param p2, "x2"    # B
    ...
    .prologue
    .line 53
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/samsung/cpp/CPPProvider;->requestCellHistory(BBBB)Z
...
.method static synthetic access$2000(Lcom/samsung/cpp/CPPProvider;)Z
    .locals 1
    .param p0, "x0"    # Lcom/samsung/cpp/CPPProvider;
...
.method static synthetic access$2100(Lcom/samsung/cpp/CPPProvider;)Lcom/samsung/cpp/ICPPLocationListener;
    .locals 1
    .param p0, "x0"    # Lcom/samsung/cpp/CPPProvider;
...
.method static synthetic access$2300(Lcom/samsung/cpp/CPPProvider;IIIIII)I
    .locals 1
    .param p0, "x0"    # Lcom/samsung/cpp/CPPProvider;
    .param p1, "x1"    # I
    .param p2, "x2"    # I
...
.method static synthetic access$2400(Lcom/samsung/cpp/CPPProvider;III)Z
    .locals 1
    .param p0, "x0"    # Lcom/samsung/cpp/CPPProvider;
    .param p1, "x1"    # I
    .param p2, "x2"    # I
...
.method static synthetic access$2600(Lcom/samsung/cpp/CPPProvider;)I
    .locals 1
    .param p0, "x0"    # Lcom/samsung/cpp/CPPProvider;
...
.method static synthetic access$2602(Lcom/samsung/cpp/CPPProvider;I)I
    .locals 0
    .param p0, "x0"    # Lcom/samsung/cpp/CPPProvider;
    .param p1, "x1"    # I
...
.method static synthetic access$2608(Lcom/samsung/cpp/CPPProvider;)I
    .locals 2
    .param p0, "x0"    # Lcom/samsung/cpp/CPPProvider;
...
.method static synthetic access$2700(Lcom/samsung/cpp/CPPProvider;)Z
    .locals 1
    .param p0, "x0"    # Lcom/samsung/cpp/CPPProvider;
...
.method static synthetic access$2702(Lcom/samsung/cpp/CPPProvider;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/samsung/cpp/CPPProvider;
    .param p1, "x1"    # Z
...
.method static synthetic access$2800(Lcom/samsung/cpp/CPPProvider;)Lcom/samsung/cpp/CPPSrvCommunicator;
    .locals 1
    .param p0, "x0"    # Lcom/samsung/cpp/CPPProvider;
...
.method static synthetic access$2900(Lcom/samsung/cpp/CPPProvider;Z[B)V
    .locals 0
    .param p0, "x0"    # Lcom/samsung/cpp/CPPProvider;
    .param p1, "x1"    # Z
    .param p2, "x2"    # [B
...
.method private cellHistoryCallBack([B)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/samsung/cpp/CPPProvider;->makeJsonForGeo(Z[B)V
...
.method private geoFenceCallBack([B)V
    ...
    const-string v22, "geoFenceCallBack() length : "
    ...
    aput-short v21, v16, v20

    .line 983
    .local v16, "measuredCellSignalPower":[S
    ...
    const-string v22, "geoFenceCallBack() ByteBuffer : "
    ...
    const-string v22, "geoFenceCallBack() type : "
    ...
    const-string v21, "geoFenceCallBack onError cb null"

    invoke-static/range {v20 .. v21}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 1044
    .end local v5    # "bb":Ljava/nio/ByteBuffer;
    .end local v8    # "clientID":I
    ...
    const-string v20, "android.intent.action.ACTION_CLM_TT_GEO_FENCE_UPDATE"
    ...
    invoke-virtual {v12, v0, v8}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    .line 1012
    const-string v20, "geoMode"

    move-object/from16 v0, v20

    invoke-virtual {v12, v0, v10}, Landroid/content/Intent;->putExtra(Ljava/lang/String;B)Landroid/content/Intent;
    ...
    iget-object v0, v0, Lcom/samsung/cpp/CPPProvider;->mContext:Landroid/content/Context;
    ...
    .line 1041
    .end local v5    # "bb":Ljava/nio/ByteBuffer;
    .end local v7    # "cellId":I
    .end local v8    # "clientID":I
    .end local v10    # "geoMode":B
    ...
    .line 1042
    .local v11, "i":Ljava/lang/Exception;
    invoke-virtual {v11}, Ljava/lang/Exception;->printStackTrace()V

    goto/16 :goto_0

    .line 1016
    .end local v11    # "i":Ljava/lang/Exception;
    .restart local v5    # "bb":Ljava/nio/ByteBuffer;
    .restart local v19    # "type":B
    :cond_2
    :try_start_1
    ...
    .line 1029
    .local v6, "cb":Landroid/os/Bundle;
    const-string v20, "geo_cb"
    ...
    iget-object v0, v0, Lcom/samsung/cpp/CPPProvider;->mHandler:Lcom/samsung/cpp/CPPProvider$CPPEventHandler;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/samsung/cpp/CPPProvider$CPPEventHandler;->sendMessageDelayed(Landroid/os/Message;J)Z

    goto/16 :goto_0

    .line 1034
    .end local v6    # "cb":Landroid/os/Bundle;
...
.method private getEncKey(IJ)J
    ...
    invoke-virtual {v4}, Lcom/samsung/cpp/CPPPolicyHandler;->getPolicyId()Ljava/lang/Long;
...
.method private makeJsonForGeo(Z[B)V
    ...
    const-string v29, "CPProvider"

    new-instance v30, Ljava/lang/StringBuilder;

    invoke-direct/range {v30 .. v30}, Ljava/lang/StringBuilder;-><init>()V

    const-string v31, "makeJsonForGeo() ByteBuffer "
    ...
    iget-boolean v0, v0, Lcom/samsung/cpp/CPPProvider;->mWifiScanning:Z
    ...
    .end local v27    # "wifiCount":I
    .local v28, "wifiCount":I
    :goto_1
    ...
    .end local v28    # "wifiCount":I
    .restart local v27    # "wifiCount":I
    ...
    .end local v17    # "mcc":S
    .end local v18    # "measuredCellNum":S
    .end local v19    # "mnc":S
    .end local v20    # "pci":I
    .end local v21    # "rat":B
    ...
    .line 1312
    .restart local v2    # "accuracy":S
    .restart local v6    # "fcn":I
    .restart local v8    # "gci":J
    .restart local v10    # "i$":Ljava/util/Iterator;
    .restart local v12    # "lat":I
    .restart local v13    # "lon":I
    .restart local v16    # "mJsonWifiArray":Lorg/json/JSONArray;
    .restart local v17    # "mcc":S
    .restart local v18    # "measuredCellNum":S
    .restart local v19    # "mnc":S
    .restart local v20    # "pci":I
    .restart local v21    # "rat":B
    .restart local v24    # "timestamp":J
    .restart local v28    # "wifiCount":I
    :cond_3
    const-string v29, "arrMacAddress"
    ...
    iput-boolean v0, v1, Lcom/samsung/cpp/CPPProvider;->mWifiScanning:Z
    :try_end_0
    ...
    const-string v31, "makeJsonForGeo() JSON : "
    ...
    const-string v31, "makeJsonForCellHistory() JSONException : "
    ...
    const-string v31, "makeJsonForCellHistory() Exception : "
...
.method private native requestCellHistory(BBBB)Z
.end method
...
.method public requestCPLocationUpdates(Lcom/samsung/cpp/CPPositioningService$RequestLocationInput;)V
    ...
    .line 227
    iget v0, p1, Lcom/samsung/cpp/CPPositioningService$RequestLocationInput;->mInterval:I

    if-ge v0, v3, :cond_2

    .line 228
    iput v3, p1, Lcom/samsung/cpp/CPPositioningService$RequestLocationInput;->mInterval:I
...
.method public sendLargeRequest()V
    ...
    invoke-virtual {v1, v2, v9}, Lcom/samsung/cpp/CPPDbAdapter;->getReq(Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;

    move-result-object v8

    .line 1114
    .local v8, "mC1":Landroid/database/Cursor;
    ...
    const-string v9, "sendLargeRequest() Large Scale Request Count in Req DB : "
    ...
    const-string v9, "sendLargeRequest() Large Scale req_id : "
    ...
    .line 1123
    invoke-virtual {p0, v8, v7}, Lcom/samsung/cpp/CPPProvider;->makeJsonForDbRequest(Landroid/database/Cursor;I)Ljava/lang/String;
    ...
    invoke-virtual/range {v1 .. v7}, Lcom/samsung/cpp/CPPSrvCommunicator;->sendToSrv(ILjava/lang/String;JII)V
