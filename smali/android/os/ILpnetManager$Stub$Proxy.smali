.class Landroid/os/ILpnetManager$Stub$Proxy;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Landroid/os/ILpnetManager$Stub;
.end annotation
...
.method constructor <init>(Landroid/os/IBinder;)V
    ...
    .line 140
    iput-object p1, p0, Landroid/os/ILpnetManager$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public asBinder()Landroid/os/IBinder;
    ...
    .prologue
    .line 144
    iget-object v0, p0, Landroid/os/ILpnetManager$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public enableDisableSolution(Z)V
    ...
    .line 226
    iget-object v2, p0, Landroid/os/ILpnetManager$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public forceStopPackage(Ljava/lang/String;)V
    ...
    .local v1, "_reply":Landroid/os/Parcel;
    :try_start_0
    const-string v2, "android.os.ILpnetManager"
...
.method public getLRUList(I)Ljava/util/Map;
    ...
    .local v1, "_reply":Landroid/os/Parcel;
    :try_start_0
    const-string v4, "android.os.ILpnetManager"
    ...
    .line 242
    iget-object v4, p0, Landroid/os/ILpnetManager$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public getManagedAppList()Ljava/util/List;
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public unFreezeApps([Ljava/lang/String;)V
    .locals 5
    .param p1, "aApps"    # [Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
