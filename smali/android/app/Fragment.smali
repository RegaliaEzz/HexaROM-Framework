...
.method public constructor <init>()V
    ...
    .line 392
    iput v3, p0, Landroid/app/Fragment;->mIndex:I

    .line 404
    iput v3, p0, Landroid/app/Fragment;->mTargetIndex:I
...
.method performConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    sget-object v1, Landroid/app/im/InjectionConstants$DispatchParentCall;->ONCONFIGURATIONCHANGED:Landroid/app/im/InjectionConstants$DispatchParentCall;

    invoke-virtual {v0, v1, p0, p1}, Landroid/app/im/InjectionManager;->dispatchParentCallToFeature(Landroid/app/im/InjectionConstants$DispatchParentCall;Ljava/lang/Object;Landroid/content/res/Configuration;)V
...
.method performContextItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 2433
    iget-object v1, p0, Landroid/app/Fragment;->mInjectionManager:Landroid/app/im/InjectionManager;

    if-eqz v1, :cond_1

    iget-object v1, p0, Landroid/app/Fragment;->mInjectionManager:Landroid/app/im/InjectionManager;

    invoke-virtual {v1, p0, p1}, Landroid/app/im/InjectionManager;->dispatchContextItemSelected(Ljava/lang/Object;Landroid/view/MenuItem;)Z
...
.method performCreate(Landroid/os/Bundle;)V
    ...
    iput-object v1, p0, Landroid/app/Fragment;->mInjectionManager:Landroid/app/im/InjectionManager;
    ...
    sget-object v2, Landroid/app/im/InjectionConstants$DispatchParentCall;->ONCREATE:Landroid/app/im/InjectionConstants$DispatchParentCall;

    const/4 v3, 0x1

    invoke-virtual {v1, v2, p0, p1, v3}, Landroid/app/im/InjectionManager;->dispatchParentCallToFeature(Landroid/app/im/InjectionConstants$DispatchParentCall;Ljava/lang/Object;Landroid/os/Bundle;Z)V

    .line 2253
    :cond_1
    instance-of v1, p0, Landroid/preference/PreferenceFragment;
    ...
    .line 2255
    iget-object v2, p0, Landroid/app/Fragment;->mInjectionManager:Landroid/app/im/InjectionManager;

    move-object v1, p0

    check-cast v1, Landroid/preference/PreferenceFragment;

    invoke-virtual {v2, v1}, Landroid/app/im/InjectionManager;->dispatchPreferences(Ljava/lang/Object;)V
...
.method performCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)Z
    ...
    invoke-virtual {v1, p0, p1, p2, v2}, Landroid/app/im/InjectionManager;->dispatchCreateOptionsMenu(Ljava/lang/Object;Landroid/view/Menu;Landroid/view/MenuInflater;Z)Z
...
.method performDestroy()V
    ...
    iget-object v2, p0, Landroid/app/Fragment;->myName:Ljava/lang/String;
...
.method performOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {v1, p0, p1}, Landroid/app/im/InjectionManager;->dispatchOptionsItemSelected(Ljava/lang/Object;Landroid/view/MenuItem;)Z
...
.method performPrepareOptionsMenu(Landroid/view/Menu;)Z
    ...
    invoke-virtual {v1, p0, p1}, Landroid/app/im/InjectionManager;->dispatchPrepareOptionsMenu(Ljava/lang/Object;Landroid/view/Menu;)Z
...
.method public registerForContextMenu(Landroid/view/View;)V
    ...
    .prologue
    .line 1772
    iget-object v0, p0, Landroid/app/Fragment;->mFeatureContextMenuListener:Landroid/view/View$OnCreateContextMenuListener;
