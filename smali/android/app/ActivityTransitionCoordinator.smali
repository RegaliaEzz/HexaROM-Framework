...
.method public static isInTransitionGroup(Landroid/view/ViewParent;Landroid/view/ViewGroup;)Z
    ...
    invoke-virtual {v5}, Landroid/view/ViewRootImpl;->getMultiWindowStyle()Lcom/samsung/android/multiwindow/MultiWindowStyle;
    ...
    invoke-static {v3, p1}, Landroid/app/ActivityTransitionCoordinator;->isInTransitionGroup(Landroid/view/ViewParent;Landroid/view/ViewGroup;)Z
...
.method protected moveSharedElementsToOverlay()V
    ...
    .prologue
    .line 803
    iget-object v11, p0, Landroid/app/ActivityTransitionCoordinator;->mWindow:Landroid/view/Window;

    if-eqz v11, :cond_0

    iget-object v11, p0, Landroid/app/ActivityTransitionCoordinator;->mWindow:Landroid/view/Window;

    invoke-virtual {v11}, Landroid/view/Window;->getSharedElementsUseOverlay()Z
    ...
    .line 807
    iget-object v11, p0, Landroid/app/ActivityTransitionCoordinator;->mSharedElements:Ljava/util/ArrayList;
    ...
    invoke-virtual {v11}, Landroid/view/ViewRootImpl;->getMultiWindowStyle()Lcom/samsung/android/multiwindow/MultiWindowStyle;
    ...
    invoke-virtual {v11}, Landroid/view/Window;->getContentRootContainer()Landroid/view/View;
    ...
    .line 825
    .end local v0    # "contentRoot":Landroid/view/View;
    .end local v3    # "isPenWindow":Z
    :cond_2
    ...
    .line 827
    .local v9, "tempMatrix":Landroid/graphics/Matrix;
    const/4 v2, 0x0
    ...
    .line 830
    iget-object v11, p0, Landroid/app/ActivityTransitionCoordinator;->mSharedElementParentMatrices:Ljava/util/ArrayList;
    ...
    .line 831
    invoke-virtual {v1, v9}, Landroid/view/ViewGroup;->transformMatrixToLocal(Landroid/graphics/Matrix;)V

    .line 832
    invoke-static {v10, v1, v9}, Landroid/view/GhostView;->addGhost(Landroid/view/View;Landroid/view/ViewGroup;Landroid/graphics/Matrix;)Landroid/view/GhostView;
    ...
    invoke-static {v8, v1}, Landroid/app/ActivityTransitionCoordinator;->isInTransitionGroup(Landroid/view/ViewParent;Landroid/view/ViewGroup;)Z
    ...
    invoke-direct {v4, v10, v8, v1}, Landroid/app/ActivityTransitionCoordinator$GhostViewListeners;-><init>(Landroid/view/View;Landroid/view/View;Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {v11, v4}, Landroid/view/ViewTreeObserver;->addOnPreDrawListener(Landroid/view/ViewTreeObserver$OnPreDrawListener;)V

    .line 837
    iget-object v11, p0, Landroid/app/ActivityTransitionCoordinator;->mGhostViewListeners:Ljava/util/ArrayList;
    ...
    .end local v9    # "tempMatrix":Landroid/graphics/Matrix;
