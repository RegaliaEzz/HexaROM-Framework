...
.method public addCredential(Landroid/net/wifi/passpoint/WifiPasspointCredential;)Z
    ...
    :try_start_0
    const-string v4, "android.net.wifi.passpoint.IWifiPasspointManager"
    ...
    invoke-virtual {p1, v0, v4}, Landroid/net/wifi/passpoint/WifiPasspointCredential;->writeToParcel(Landroid/os/Parcel;I)V

    .line 241
    :goto_0
    iget-object v4, p0, Landroid/net/wifi/passpoint/IWifiPasspointManager$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public getCredentials()Ljava/util/List;
    ...
    .local v1, "_reply":Landroid/os/Parcel;
    :try_start_0
    const-string v3, "android.net.wifi.passpoint.IWifiPasspointManager"
